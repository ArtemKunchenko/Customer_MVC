...
namespace Customer_MVC.Services
{
    ...
    public class ServiceCustomers: IServiceCustomers
    {
        ...
        public bool Delete(int id)
        {
            Customer customer = _customerContext?.Customers.FirstOrDefault(p => p.Id == id);
        ...
        public Customer? GetById(int id)
        {
            return _customerContext?.Customers.FirstOrDefault(p => p.Id == id);
        }
